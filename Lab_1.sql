...
END
EXEC GET_ADRESS_SUPERMARKETS 'ул. Свердлова';
-------------------------
 SELECT adress, ['одежда'], ['Обувь'], ['Аксессуары']
   FROM dbo.Supermarkets
   PIVOT (count(description)for type in ( ['одежда'], ['Обувь'], ['Аксессуары'])
...
VALUES (3, 'ул. 1мая','Обувь', 'Супер'),
	   (4,'ул. Немига','Аксессуары', 'Мило');
